...
// Bu 3 ArrayList'i 2D ArrayList'te saklayın
    ...
    public static void main(String[] args) {
        ...
        calısanlar.add("Elif");
        calısanlar.add("Tecnical support");

        System.out.println(calısanlar); //[Ahmet, Ali, Emrah, Elif, Tecnical support]
...
//[[Ahmet, Ali, Emrah, Elif, Tecnical support], [Haluk, Eylül, Yusuf, Can, İbrahim, Mehmet], [Amazon, Google, Testinium, IBM]]
