 ...
 public static void main(String[] args) {
   ...
   Scanner scan = new Scanner(System.in);
    ...
    for (int i = 0; i < 5; i++) {
     ...
     System.out.println("ters sıramadan sonra "+arrList);


     Collections.shuffle(arrList); //Rastgele karıstırır
     System.out.println("Karıstırarak "+arrList);

     Collections.rotate(arrList,3); //belirtilen listedeki ögeleri kaydırır
     System.out.println("Kaydırarak "+arrList);
     ...
     Collections.replaceAll(arrList,max,max);
