...
// ve tüm karakterleri sete ekleyin
    ...
    public static void main(String[] args) {
        ...
        arrListenSeteDonustur(arrList,set);
        System.out.println(set); //[50, 20, 10, 30]

        Set<Character> characterSet=new HashSet<>();
        karakterleriSeteEkle(characterSet, 'A','B','R','r','q');
        System.out.println(characterSet); //[A, q, B, R, r]
    ...
    private static void arrListenSeteDonustur(ArrayList<Integer> arrList, Set<Integer> set) {
